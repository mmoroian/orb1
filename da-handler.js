document.addEventListener("DOMContentLoaded", () => {
  ...
  const countryNameInput = document.getElementById("da_country_name");
  ...
  window.loadDACompanyByName = async () => {
    ...
    try {
      ...
      countryNameInput.value = found.country_name || ""; // NEW
  ...
  form.addEventListener("submit", async (e) => {
    ...
    if (!country_name) return alert("Please enter a country");
